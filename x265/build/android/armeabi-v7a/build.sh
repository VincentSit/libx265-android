cmake ../../../source \
  ...
  -DCMAKE_CXX_COMPILER="${NDK_ROOT}/toolchains/llvm/prebuilt/${HOST_TAG}/bin/armv7a-linux-androideabi${ANDROID_API_VERSION}-clang++" \
  -DCMAKE_C_COMPILER="${NDK_ROOT}/toolchains/llvm/prebuilt/${HOST_TAG}/bin/armv7a-linux-androideabi${ANDROID_API_VERSION}-clang" \
  -DENABLE_SHARED=0 \
  -DNEON_ANDROID=1
